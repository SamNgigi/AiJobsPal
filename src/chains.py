...
class Chain:
    def __init__(self):
        self.llm = ChatGroq(temperature=0, groq_api_key=os.getenv("GROQ_CLOUD"), model_name="llama-3.1-70b-versatile")
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            """
            ### JOB DESCRIPTION
            You are Neo, a talented Machine Learning and software engineer dedicated to seamliess integration
        ...
        res = chain_email.invoke({"job_description" : str(job), "link_lst": links})
        return res.content

if __name__ == "__main__":
    print(os.getenv("GROQ_CLOUD"))
